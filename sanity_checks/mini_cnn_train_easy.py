...
def mini_cnn_train_easy():
  train_x, train_y = get_cnn_split_data("train", regime_type="easy")
  val_x, val_y = get_cnn_split_data("val", regime_type="easy")
  ...
  fig.tight_layout()
  fig.savefig(Path(__file__).resolve().parent / "mini_cnn_train_easy.png")
  plt.show()
  return metrics

if __name__ == "__main__":
  metrics = mini_cnn_train_easy()
  print(metrics)

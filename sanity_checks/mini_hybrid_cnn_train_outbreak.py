...
def mini_hybrid_cnn_train_outbreak():
  train_x, train_x_pattern, train_y = get_hybrid_cnn_split_data("train", regime_type="outbreak")
  val_x, val_x_pattern, val_y = get_hybrid_cnn_split_data("val", regime_type="outbreak")
  ...
  fig.tight_layout()
  fig.savefig(Path(__file__).resolve().parent / "mini_hybrid_cnn_train_outbreak.png")
  plt.show()
  return metrics

if __name__ == "__main__":
  metrics = mini_hybrid_cnn_train_outbreak()
  print(metrics)

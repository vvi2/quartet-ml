...
def evaluate_hybrid_cnn():
  ...
  pd.DataFrame({"method": "Hybrid CNN", "regime": regimes, "internal_branch_length": internal_branch_lengths, "correct": correct}).to_csv(headline_file_path / "hybrid_cnn.csv", index=False)
